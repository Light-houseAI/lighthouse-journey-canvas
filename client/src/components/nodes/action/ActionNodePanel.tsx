...
const ActionView: React.FC<ActionViewProps> = ({ node, onEdit, onDelete, canEdit, isDeleting }) => {
...
export const ActionNodePanel: React.FC<ActionNodePanelProps> = ({ node, deleteNode: deleteNodeProp }) => {
