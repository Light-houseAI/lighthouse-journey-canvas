/**
 * EducationNode - Dedicated Education Node Component
 *
 * Specialized node component for education experiences with optimized layout
 * and education-specific information display.
 */
...
// Props passed to EducationNode by React Flow
...
export const EducationNode: React.FC<NodeProps<EducationNodeData>> = ({
  data,
}) => {
  const {
    node,
  ...
  // Education-specific node styling with academic theme
  const getEducationNodeStyle = (): React.CSSProperties => {
    const baseColor = '#059669'; // Deep emerald for growth and learning
    const accentColor = '#047857'; // Even deeper emerald
    const isHighlighted = isSelected || isFocused;

    return {
      // Academic gradient with education-specific colors
      ...
      borderRadius: '20px',
      padding: '0px',
      width: '240px', // Slightly wider for education info
      height: '180px', // Taller for institution + degree info
  ...
  return (
    <div
      ref={nodeRef}
      style={getEducationNodeStyle()}
      onClick={handleNodeClick}
      onMouseEnter={handleMouseEnter}
      onMouseLeave={handleMouseLeave}
      className="education-node group relative transform hover:scale-[1.02] transition-transform duration-300"
    >
      ...
      <Handle
        ...
        id="left"
        style={{ background: '#059669', border: 'none', width: 8, height: 8 }}
      />
      ...
      {/* Education-specific layout: Icon+Label | Institution | Degree | Field | Actions */}
      ...
      {/* Education-specific Hover Tooltip */}
      {isHovered && createPortal(
        ...
        >
          {/* Enhanced Education Tooltip */}
          <div
            style={{
              ...getEducationNodeStyle(),
              width: '360px',
              height: '240px',
          ...
          >
            ...
            <div className="relative z-10 h-full w-full flex flex-col justify-between px-4">
              ...
              {/* Row 2: Enhanced Education Information */}
