...
export const ResumeUpdateStep: React.FC<ResumeUpdateStepProps> = ({
  data,
  onNext,
  onBack,
  onCancel,
  ...
  const [notes, setNotes] = useState(data?.resumeUpdateNotes || '');

  const handleNext = () => {
    onNext({
      resumeUpdateData: {},
      resumeUpdateNotes: notes,
    });
  };
      ...
      <div className="flex h-[90vh] w-[90vw] max-w-6xl overflow-hidden rounded-lg bg-white shadow-xl">
        <div className="w-1/3 bg-gray-50 p-8">
          <div className="text-sm font-medium text-gray-900">
            Step {currentStep + 1} of {totalSteps}: Resume/Portfolio Update
          </div>
        </div>
        ...
        <div className="flex flex-1 flex-col">
          ...
          <div className="flex-1 overflow-y-auto px-8 py-6">
            <h1 className="mb-4 text-3xl font-bold text-gray-900">Resume/Portfolio Update</h1>
            <p className="mb-6 text-gray-600">Share details about your resume or portfolio updates.</p>
            <div className="flex flex-col gap-2">
              <Label htmlFor="resumeNotes" className="text-sm font-medium text-gray-700">
                Notes
              </Label>
              <Textarea
                id="resumeNotes"
                ...
                placeholder="e.g., Updated resume with latest project experience, added new portfolio case study..."
