...
interface SkillDevelopmentStepProps {
  data: WizardData;
...
export const SkillDevelopmentStep: React.FC<SkillDevelopmentStepProps> = ({
  data,
  onNext,
  onBack,
  onCancel,
  ...
  const [notes, setNotes] = useState(data?.skillDevelopmentNotes || '');

  const handleNext = () => {
    onNext({
      skillDevelopmentData: {},
      skillDevelopmentNotes: notes,
    });
  };
      ...
      <div className="flex h-[90vh] w-[90vw] max-w-6xl overflow-hidden rounded-lg bg-white shadow-xl">
        <div className="w-1/3 bg-gray-50 p-8">
          <div className="text-sm font-medium text-gray-900">
            Step {currentStep + 1} of {totalSteps}: Skill Development
          </div>
        </div>
        ...
        <div className="flex flex-1 flex-col">
          ...
          <div className="flex-1 overflow-y-auto px-8 py-6">
            <h1 className="mb-4 text-3xl font-bold text-gray-900">Skill Development</h1>
            <p className="mb-6 text-gray-600">Share details about skills you developed or learned.</p>
            <div className="flex flex-col gap-2">
              <Label htmlFor="skillNotes" className="text-sm font-medium text-gray-700">
                Notes
              </Label>
              <Textarea
                id="skillNotes"
                ...
                placeholder="e.g., Completed React course, practiced algorithms on LeetCode..."
