...
const mockGetUserOrganizations = vi.mocked(organizationApi.getUserOrganizations);
...
describe('useSearchOrganizations', () => {
  ...
  it('should return empty array when search returns no results', async () => {
    ...
    const { result } = renderHook(() => useSearchOrganizations('Nonexistent', true), {
      wrapper: createWrapper(),
    });
...
describe('useCreateOrganization', () => {
  ...
  it('should create organization successfully', async () => {
    ...
    const orgData = { name: 'New Startup', type: 'company' as OrganizationType };
  ...
  it('should invalidate user organizations cache after creation', async () => {
    ...
    const { result: userOrgsResult } = renderHook(() => useUserOrganizations(), {
      wrapper,
    });
