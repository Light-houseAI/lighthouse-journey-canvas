...
import type { ApplicationMaterials, ResumeVersion, TimelineNode } from '@journey/schema';
...
describe('useApplicationMaterials', () => {
  ...
  it('should cache materials with stale time', async () => {
    ...
    const firstCallCount = mockHierarchyApi.getApplicationMaterials.mock.calls.length;
...
describe('useUpdateApplicationMaterials', () => {
  ...
  it('should rollback on error', async () => {
    ...
    const originalData = fetchResult.current.data;
  ...
  it('should merge partial updates', async () => {
    ...
    mockHierarchyApi.getApplicationMaterials.mockResolvedValue(existingMaterials);
...
describe('useRemoveResumeEntry', () => {
  ...
  it('should handle removal error', async () => {
    ...
    await expect(result.current.mutateAsync('resume-general')).rejects.toThrow();
  });
});
...
describe('useCareerTransitionNode', () => {
  ...
  it('should fetch career transition node successfully', async () => {
    ...
    expect(mockHierarchyApi.getNode).toHaveBeenCalledWith(mockCareerTransitionId);
  });
