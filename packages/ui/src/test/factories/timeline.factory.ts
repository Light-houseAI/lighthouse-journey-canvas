 ...
 */
export const createMockTimelineNode = (overrides?: Partial<TimelineNode>): TimelineNode => ({
  id: 'node-1',
  type: 'job',
 ...
 */
export const createMockJobNode = (overrides?: Partial<TimelineNode>): TimelineNode => ({
  ...createMockTimelineNode({
    type: 'job',
    title: 'Software Engineer',
    company: 'Tech Corp',
 ...
 */
export const createMockEducationNode = (overrides?: Partial<TimelineNode>): TimelineNode => ({
  ...createMockTimelineNode({
    type: 'education',
