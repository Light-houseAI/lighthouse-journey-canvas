 ...
 */
// TODO: LIG-175 - Update test to work with ProfileListView instead of ReactFlow
test.describe.skip(
  'Complete User Journey - SKIPPED: ReactFlow removed, needs update for ProfileListView',
  () => {
    const testUser = {
    ...
    test('complete user journey: signup, onboarding, timeline operations, and insights management', async ({
      page,
    }) => {
      ...
      await test.step('Onboarding Flow', async () => {
        ...
        await expect(
          page.getByText('What are you most interested')
        ).toBeVisible();
      ...
      await test.step('Profile Data Extraction', async () => {
        ...
        await page
          .getByRole('textbox', { name: 'LinkedIn Profile URL' })
          .click();
        await page
          .getByRole('textbox', { name: 'LinkedIn Profile URL' })
          .fill('ugudlado');
        await page
          .getByRole('button', { name: 'Extract Profile Data' })
          .click();

        // Review and save profile data
        await expect(
          page.getByRole('heading', { name: 'Review Profile Data' })
        ).toBeVisible();
        await page.getByRole('button', { name: 'Save Profile' }).click();

        // Verify timeline access
        await expect(
          page.getByRole('heading', { name: 'Your Professional Journey' })
        ).toBeVisible();
      ...
      await test.step('Profile Settings Management', async () => {
        ...
        await expect(
          page.getByRole('button', { name: 'MG Mahesh Gudladona' })
        ).toBeVisible();
      ...
      await test.step('Timeline Node Operations', async () => {
        ...
        await page
          .getByTestId('rf__node-d2bc47a9-64ff-4886-8868-f597d2e89cea')
          .click();
        ...
        await page
          .getByRole('textbox', { name: 'Role *' })
          .fill('General employee at food services');
        await page.getByTestId('submit-button').click();
      ...
      await test.step('Insights Management', async () => {
        ...
        // Fill insight form
        await page
          .getByRole('textbox', { name: 'Share your insight *' })
          .fill('Testing new insights');
        await page
          .getByRole('textbox', { name: 'URL, book reference, note,' })
          .click();
        await page
          .getByRole('textbox', { name: 'URL, book reference, note,' })
          .fill('book');
      ...
      await test.step('Additional Node Operations', async () => {
        ...
        await page
          ...
          .filter({
            hasText:
              'JOBopendoorstaff software engineerJul 2022 - Present+JOBabco india private',
          })
          .nth(1)
          .click();
        await page
        ...
        await page
          ...
          .fill('Description');
        await page
          .getByText('Title *DescriptionDescriptionProject TypeSelect')
          .click();
        await page
          .getByText('Title *DescriptionDescriptionProject TypeSelect')
          .click();
        ...
        await page
          ...
          .click();
        await page
          .getByTestId('rf__node-8fd86fc3-e911-4ae0-9058-3f84fec652b2')
          .click();
        await expect(
      ...
      await test.step('Node Hierarchy and Cleanup', async () => {
        ...
        await page
          ...
          .click();
        await page
          .getByTestId('rf__node-839af02d-f58d-41ed-86d8-d8b1a931ae39')
          .click();
        await expect(
          page.getByRole('heading', { name: 'Starting new project' })
        ).toBeVisible();
        ...
        // Test node deletion
        await page
          .getByTestId('rf__node-ff8a572d-cb14-40cb-93e5-775ef9da07a1')
          .click();
        await page.getByRole('button', { name: 'Delete' }).click();
        await page.getByRole('button', { name: 'Delete' }).click();
        await page.getByRole('button', { name: 'fit view' }).click();
