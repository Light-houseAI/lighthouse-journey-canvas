...
const mockApiSuccessResponseSchema = vi.mocked(apiSuccessResponseSchema);
...
describe('MappedResponse', () => {
  ...
  describe('withSchema', () => {
    ...
    it('should validate union types', () => {
      ...
      const dataSchema = z.union([
        ...
        z.object({ type: z.literal('admin'), id: z.number(), privileges: z.array(z.string()) }),
      ]);
  ...
  describe('Type Safety', () => {
    ...
    it('should work with tuple types', () => {
      ...
      const mappedResponse = new MappedResponse<[string, number, boolean]>(tuple);
      const unwrapped = mappedResponse.unwrap();
  ...
  describe('Integration with Express', () => {
    it('should work with typical controller response pattern', () => {
      ...
      const response = new MappedResponse(userData).withSchema(userSchema, 'UserResponse');
    ...
    it('should work with list response pattern', () => {
      ...
      const response = new MappedResponse(users).withSchema(usersSchema, 'UsersList');
