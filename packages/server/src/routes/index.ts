...
import nanoAgentRoutes from './nano-agent.routes.js';
import workflowAnalysisRoutes from './workflow-analysis.routes.js';
import contextStitchingRoutes from './context-stitching.routes.js';
...
router.use('/v2/nano-agent', nanoAgentRoutes);
router.use('/v2/context-stitching', contextStitchingRoutes);
