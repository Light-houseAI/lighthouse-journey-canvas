 ...
 *
 * Usage:
 *   npx tsx generate-realistic-test-users.ts --count 10 --persona engineer
 *   npx tsx generate-realistic-test-users.ts --count 50 --mixed
...
program
  .name('generate-realistic-test-users')
